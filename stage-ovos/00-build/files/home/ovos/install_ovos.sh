...
pip3 install git+https://github.com/OpenVoiceOS/ovos_PHAL
...
pip3 install git+https://github.com/OpenVoiceOS/ovos-ww-plugin-vosk.git
...
# install skills
# pip3 install git+https://github.com/OpenVoiceOS/skill-ovos-setup
# from NeonGeckoCom
