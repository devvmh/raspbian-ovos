...
# These pull a lot of stuff that make this image heavy
# Uncomment to install
#pip3 install git+https://github.com/NeonGeckoCom/skill-stock
#pip3 install git+https://github.com/NeonGeckoCom/skill-user_settings
#pip3 install git+https://github.com/NeonGeckoCom/skill-speed_test
